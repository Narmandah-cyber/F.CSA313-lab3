...
## 10. Хэмжихээс өмнөх таамаг ба хэмжилтийн үр дүн

Сценариогоо бичихээс өмнө `server.js`-ийг уншаад дараах таамгуудыг дэвшүүлж, дараа нь баримтаар шалгалаа.

**Хурдны таамаг таарсан.** `/report` нь кодондоо зориудын `sleep` агуулдаг тул хамгийн удаан, `/cart/add` нь энгийн үйлдэл хийдэг тул хамгийн хурдан байх гэж таамагласан бөгөөд хэмжилт (report p95 = 393.35 мс, cart p95 = 1.83 мс) үүнийг яг баталсан.

**Харин тоон таамаг маань бага зэрэг хэтэрсэн байсан.** `/cart/add`-ыг "20 мс-ээс бага" гэж төсөөлж байсан ч бодит утга нь 1.83 мс буюу таамгаас 10 дахин хурдан гарсан. Хэрэв би босгоо хэмжилгүйгээр таамгаараа тавьсан бол `p(95)<20` гэсэн шалгуур ямар ч удаашралыг барихгүй "хоосон" threshold болох байсан — энэ нь яагаад SLO-г baseline хэмжилтээс гаргах ёстойг харуулсан хамгийн тод жишээ.

**Алдааны босгын хувьд таамаг маань хэт хатуу байв.** Төлбөрийн endpoint учраас "5%-иас дээш алдаа хүлээн зөвшөөрөгдөхгүй" гэж бодож, хэлбэлзлийн нөөц үлдээх тухай огт бодоогүй. Гэтэл гурван ажиллуулалтад `/pay`-ийн алдаа 4.73%, 5.05%, 5.07% гэж 5%-ийн эргэн тойронд хэлбэлзсэн тул яг 5% гэсэн босго нь эрүүл систем дээр ч санамсаргүй FAIL өгөх байсан — иймээс эцсийн SLO-гоо 8% болгож статистик хэлбэлзлийн нөөц үлдээв.

**Эвдрэлийг би чанарын сценарио гэж үзээгүй.** Алхам 5-ыг уншихаас өмнө чанарыг зөвхөн хэвийн ажиллагааны хариу хугацаа, алдааны хувиар л төсөөлж байсан бөгөөд серверийн уналт нь бие даасан сценарио болохыг бодоогүй. Мөн сервер унавал алдааны хувь өсөхөөс гадна хариу өгөх хугацаа ч муудна гэж таамагласан.

**Chaos туршилт энэ таамгийг няцаав.** Зогсолтын үед checks 87.77% болж, `/pay` 15.34% алдаа өгсөн атлаа cart (1.76 мс) болон report (391.92 мс)-ын p95 огт өөрчлөгдөөгүй — учир нь унасан хүсэлт хугацаа зарцуулахгүй шууд буцдаг (`min=0s`). Өөрөөр хэлбэл нэг ижил эвдрэл өөр өөр чанарын шинжийг тэс өөрөөр хөндөж байгааг практикаар харлаа: зөвхөн latency хардаг мониторинг энэ 10 секундын уналтыг огт "хараагүй" өнгөрөх байсан.

**Дүгнэлт:** таамаг нь аль endpoint асуудалтай болохыг зөв заасан ч тоон утгыг нь яг зөв хэлж чадаагүй, мөн ямар эвдрэл ямар хэмжүүрт нөлөөлөхийг буруу таасан. Сценариог утга талаас нь зөв бодох нь эхлэл төдий бөгөөд босго тавихын өмнө заавал хэмжих ёстой гэдгийг энэ лаб-аас ойлголоо.

## 11. AI ашиглалтын тэмдэглэл

Энэ лабораторид AI туслахыг k6 скрипт болон тайлангийн бүтэц бэлтгэхэд ашигласан. Бүх хэмжилтийг өөрийн машин дээрх локал сервер рүү ажиллуулж, гаралтын файл, дэлгэцийн зураг, дээрх таамаг-үр дүнгийн харьцуулалтыг өөрөө хийсэн.
