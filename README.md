...
**Хурдны таамаг батлагдсан.** `/report` нь кодондоо зориудын `sleep` агуулдаг тул хамгийн удаан, `/cart/add` нь энгийн үйлдэл хийдэг тул хамгийн хурдан байх гэж таамагласан бөгөөд хэмжилт (report p95 = 393.35 мс, cart p95 = 1.83 мс) үүнийг яг баталсан.

**Харин тоон таамаг маань бүдүүлэг байсан.** `/cart/add`-ыг "100 мс-ээс бага" гэж төсөөлж байсан ч бодит утга нь 1.83 мс буюу таамгаас 50 гаруй дахин хурдан гарсан. Хэрэв би босгоо хэмжилгүйгээр таамгаараа тавьсан бол `p(95)<100` гэсэн шалгуур ямар ч удаашралыг барихгүй "хоосон" threshold болох байсан — энэ нь яагаад SLO-г baseline хэмжилтээс гаргах ёстойг харуулсан хамгийн тод жишээ.
...
**Дүгнэлт:** таамаг нь аль endpoint асуудалтай болохыг зөв заасан ч ТООГ нь зөв хэлж чадаагүй, мөн ямар эвдрэл ямар хэмжүүрт нөлөөлөхийг буруу таасан. Сценариог утга талаас нь зөв бодох нь эхлэл төдий бөгөөд босго тавихын өмнө заавал хэмжих ёстой гэдгийг энэ лаб надад ойлгуулсан.
